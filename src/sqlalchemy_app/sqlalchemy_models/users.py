...
from sqlalchemy import Date, DateTime, Integer, LargeBinary, String, func, text
...
class UserTokenRecord(Model):
    ...
    last_used_at = db.Column(db.DateTime, nullable=True, server_default=func.current_timestamp())
...
class UsersNoInprocessRecord(Model):
    """
...
class FullTranslatorRecord(Model):
    """
