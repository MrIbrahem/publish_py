...
class PageRecord(Model):
    ...
    add_date = db.Column(db.DateTime, nullable=False, server_default=func.current_timestamp())
...
class PagesUsersToMainRecord(Model):
    """
