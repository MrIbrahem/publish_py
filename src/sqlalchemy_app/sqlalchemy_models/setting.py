...
class LanguageSettingRecord(Model):
    """
    ...
    move_dots = db.Column(db.Integer, default=0, server_default=text("0"))
    expend = db.Column(db.Integer, default=0, server_default=text("0"))
    add_en_lang = db.Column(db.Integer, default=0, server_default=text("0"))
