...
table_creation_sql_pages_users = """
CREATE TABLE
...
class PagesDB:
    ...
    def _ensure_table(self) -> None:
        self.db.execute_query_safe(table_creation_sql_pages)
        self.db.execute_query_safe(table_creation_sql_pages_users)
