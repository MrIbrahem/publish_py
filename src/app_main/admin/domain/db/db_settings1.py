...
class SettingsDB1:
    ...
    def fetch_by_id(self, setting_id: int) -> SettingRecord1 | None:
    ...
    def fetch_by_key(self, key: str) -> SettingRecord1 | None:
    ...
    def list(self) -> List[SettingRecord1]:
    ...
    def update_value(self, setting_id: int, value: Any) -> SettingRecord1:
    ...
    def delete(self, setting_id: int) -> SettingRecord1:
