...
def list_views_new() -> list[ViewsNewRecord]:
    ...
    return list(views_new_crud.list(order_by=[ViewsNewRecord.id.asc()]))
...
def list_views_by_target(target: str, lang: str | None = None) -> list[ViewsNewRecord]:
    ...
    if lang:
        filters["lang"] = lang
    return list(views_new_crud.list(filters=filters, order_by=[ViewsNewRecord.year.desc()]))


def list_views_by_lang(lang: str) -> list[ViewsNewRecord]:
    """Return views_new records for a specific language."""
    return list(views_new_crud.list(filters={"lang": lang}, order_by=[ViewsNewRecord.id.asc()]))
