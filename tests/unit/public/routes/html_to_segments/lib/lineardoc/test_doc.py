"""
Unit tests for src/main_app/public/routes/html_to_segments/lib/lineardoc/doc.py module.
...
from src.main_app.public.routes.html_to_segments.lib.lineardoc import TextBlock, TextChunk
