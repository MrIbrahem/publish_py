"""
Unit tests for domain/services/words_service.py module.
...
import pytest
from src.app_main.public.domain.services.words_service import (
    add_or_update_word,
    add_word,
    delete_word,
    get_word,
...
class TestGetWordsDb:
    ...
    def test_returns_cached_instance_on_subsequent_calls(self, monkeypatch):
        ...
        mock_db = MagicMock()
        monkeypatch.setattr("src.app_main.public.domain.services.words_service._WORDS_STORE", mock_db)
        monkeypatch.setattr("src.app_main.public.domain.services.words_service.has_db_config", lambda: True)
    ...
    def test_raises_when_no_db_config(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.public.domain.services.words_service._WORDS_STORE", None)
        monkeypatch.setattr("src.app_main.public.domain.services.words_service.has_db_config", lambda: False)
    ...
    def test_creates_new_instance_when_cached_is_none(self, monkeypatch):
        ...
        with patch("src.app_main.public.domain.services.words_service.WordsDB") as MockWordsDB:
...
class TestListWords:
    ...
    def test_returns_list_of_words(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.public.domain.services.words_service.get_words_db", lambda: mock_store)
