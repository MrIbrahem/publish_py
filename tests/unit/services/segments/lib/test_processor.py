...
class TestProcessHtml:
    def test_process_html_with_simple_html(self):
        ...
        result = process_html(html, wrap_sections=False)
        assert normalize_test(result) == normalize_test("""
        <html id="0">
            <body id="1">
                <p id="2"><span class="cx-segment" data-segmentid="3">Simple paragraph.</span></p>
            </body>
        </html>
        """)

        wrap_result = process_html(html, wrap_sections=True)
        assert normalize_test(wrap_result) == normalize_test("""
        <html id="0">
            <body id="1">
    ...
    def test_process_html_with_complex_html(self):
        ...
        <html id="0">
            <body id="1">
                <section data-mw-section-number="0" id="cxSourceSection0" rel="cx:Section">
                    <h1 id="2"><span class="cx-segment" data-segmentid="3">Title</span></h1>
                </section>
                <section data-mw-section-number="0" id="cxSourceSection1" rel="cx:Section">
                    <p id="4"><span class="cx-segment" data-segmentid="5">First paragraph.</span></p>
                    <p id="6"><span class="cx-segment" data-segmentid="7">Second paragraph.</span></p>
                </section>
            </body>
        </html>
        """)
