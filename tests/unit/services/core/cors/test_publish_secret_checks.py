...
from src.main_app.services.core.cors.publish_secret_checks import (
...
class TestCheckPublishSecretCode:
    ...
    def test_returns_none_when_no_secret_configured(self, mock_app, monkeypatch):
        ...
        monkeypatch.setattr(
            "src.main_app.services.core.cors.publish_secret_checks._get_publish_secret_code", lambda: ""
        )
    ...
    def test_returns_none_when_no_header_present(self, mock_app, monkeypatch):
        ...
        monkeypatch.setattr(
            "src.main_app.services.core.cors.publish_secret_checks._get_publish_secret_code",
    ...
    def test_uses_timing_safe_comparison(self, mock_app, monkeypatch):
        ...
        monkeypatch.setattr(
            "src.main_app.services.core.cors.publish_secret_checks._get_publish_secret_code", lambda: "secret"
        )

        with patch("src.main_app.services.core.cors.publish_secret_checks.hmac.compare_digest") as mock_compare:
