...
from src.main_app.services.utils.helpers.words import clear_words_cache, get_word_count
...
class TestGetWordCount:
    ...
    def test_returns_zero_when_file_not_found(self, monkeypatch):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            monkeypatch.setattr("src.main_app.services.utils.helpers.words.app_settings", mock_settings)
