"""
Unit tests for src/main_app/services/new_html_services/domain/fixes/media/fix_images.py module.
...
from src.main_app.services.new_html_services.domain.fixes.media.fix_images import (
    remove_images,
    remove_videos,
)
