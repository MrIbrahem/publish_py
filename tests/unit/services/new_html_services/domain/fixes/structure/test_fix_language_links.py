"""
Unit tests for src/main_app/services/new_html_services/domain/fixes/structure/fix_language_links.py module.
...
from src.main_app.services.new_html_services.domain.fixes.structure.fix_language_links import (
    LANG_CODES,
    is_valid_lang_code,
    remove_lang_links,
)
