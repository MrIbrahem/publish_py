"""
Unit tests for src/main_app/services/new_html_services/domain/parser/lead_section_parser.py module.
...
from src.main_app.services.new_html_services.domain.parser.lead_section_parser import (
    get_lead_section,
)
