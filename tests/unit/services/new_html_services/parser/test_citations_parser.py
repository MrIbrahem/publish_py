"""
Unit tests for src/main_app/services/new_html_services/parser/citations_parser.py module.
...
from src.main_app.services.new_html_services.parser.citations_parser import (
    get_all_citations,
    get_full_refs,
    get_short_refs,
)
