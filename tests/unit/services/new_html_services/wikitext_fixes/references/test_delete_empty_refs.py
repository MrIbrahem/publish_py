"""
Unit tests for src/main_app/services/new_html_services/wikitext_fixes/references/delete_empty_refs.py module.
...
from src.main_app.services.new_html_services.wikitext_fixes.references.delete_empty_refs import (
    del_empty_refs,
)
