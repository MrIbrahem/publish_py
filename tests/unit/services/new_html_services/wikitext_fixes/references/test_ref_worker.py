"""
Unit tests for src/main_app/services/new_html_services/wikitext_fixes/references/ref_worker.py module.
...
from src.main_app.services.new_html_services.wikitext_fixes.references.ref_worker import (
    check_one_cite,
    remove_bad_refs,
)
