...
class TestGetOauthClient:
    ...
    def test_creates_oauth1_object(self):
        ...
        with patch("src.main_app.services.clients.oauth_client.settings") as mock_settings:
            ...
            from src.main_app.services.clients.oauth_client import get_oauth_client
...
class TestGetCsrfToken:
    ...
    def test_returns_token_response(self):
        ...
        with (
            ...
            from src.main_app.services.clients.oauth_client import get_csrf_token
...
class TestPostParams:
    ...
    def test_includes_csrf_token_in_request(self):
        ...
        with (
            ...
            from src.main_app.services.clients.oauth_client import post_params
...
class TestGetCxtoken:
    ...
    def test_returns_cxtoken_response(self):
        ...
        with patch("src.main_app.services.clients.oauth_client.post_params") as mock_post:
            mock_post.return_value = '{"cxtoken": "some_cx_token"}'

            from src.main_app.services.clients.oauth_client import get_cxtoken
