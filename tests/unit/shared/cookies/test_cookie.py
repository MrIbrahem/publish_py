...
from src.new_app.shared.cookies.cookie import (
    extract_user_id,
    sign_state_token,
    sign_user_id,
    verify_state_token,
...
class TestExtractUserId:
    ...
    def test_returns_none_for_malformed_data(self, monkeypatch):
        ...
        from src.new_app.shared.cookies.cookie import _serializer
    ...
    def test_returns_none_for_expired_token(self, monkeypatch):
        ...
        with patch("src.new_app.shared.cookies.cookie.settings") as mock_settings:
...
class TestVerifyStateToken:
    ...
    def test_returns_none_when_nonce_missing(self, monkeypatch):
        ...
        from src.new_app.shared.cookies.cookie import _state_serializer
