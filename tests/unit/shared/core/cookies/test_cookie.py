...
class TestExtractUserId:
    ...
    def test_returns_none_for_malformed_data(self, monkeypatch):
        ...
        from src.sqlalchemy_app.shared.core.cookies.cookie import _serializer
    ...
    def test_returns_none_for_expired_token(self, monkeypatch):
        ...
        with patch("src.sqlalchemy_app.shared.core.cookies.cookie.settings") as mock_settings:
...
class TestVerifyStateToken:
    ...
    def test_returns_none_when_nonce_missing(self, monkeypatch):
        ...
        from src.sqlalchemy_app.shared.core.cookies.cookie import _state_serializer
