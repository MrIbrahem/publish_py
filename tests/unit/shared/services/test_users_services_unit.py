"""Unit tests for users_services module.
...
import pytest
from src.app_main.shared.services.users_services import (
    delete_user_token,
...
class TestGetStore:
    ...
    def test_returns_cached_instance_on_subsequent_calls(self, monkeypatch):
        ...
        mock_db = MagicMock()
        monkeypatch.setattr("src.app_main.shared.services.users_services._user_db", mock_db)
        monkeypatch.setattr("src.app_main.shared.services.users_services.has_db_config", lambda: True)
    ...
    def test_raises_when_no_db_config(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.shared.services.users_services._user_db", None)
        monkeypatch.setattr("src.app_main.shared.services.users_services.has_db_config", lambda: False)
    ...
    def test_creates_new_instance_when_cached_is_none(self, monkeypatch):
        ...
        with patch("src.app_main.shared.services.users_services.UserTokenDB") as MockUserTokenDB:
...
class TestEnsureUserTokenTable:
    ...
    def test_calls_ensure_table_when_config_exists(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.shared.services.users_services.has_db_config", lambda: True)
        monkeypatch.setattr("src.app_main.shared.services.users_services.get_store", lambda: mock_store)
