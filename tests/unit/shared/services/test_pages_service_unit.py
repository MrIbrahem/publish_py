...
class TestGetPagesDb:
    ...
    def test_returns_cached_instance_on_subsequent_calls(self, monkeypatch):
        ...
        mock_db = MagicMock()
        monkeypatch.setattr("src.new_app.shared.services.pages_service._PAGE_STORE", mock_db)
...
class TestListPages:
    ...
    def test_returns_list_of_pages(self, monkeypatch):
        ...
        monkeypatch.setattr("src.new_app.shared.services.pages_service.get_pages_db", lambda: mock_store)
