...
class TestCurrentUserFunction:
    ...
    def test_returns_user_from_session(self, app, monkeypatch):
        ...
        monkeypatch.setattr("src.sqlalchemy_app.shared.auth.identity.get_user_token", mock_get_user_token)
    ...
    def test_updates_session_username(self, app, monkeypatch):
        ...
        monkeypatch.setattr("src.sqlalchemy_app.shared.auth.identity.get_user_token", lambda uid: mock_user)
