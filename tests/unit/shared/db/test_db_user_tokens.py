...
from src.app_main.shared.db.db_user_tokens import (
    UserTokenDB,
    UserTokenRecord,
    _coerce_bytes,
    current_ts,
...
class TestUserTokenRecord:
    ...
    @patch("src.app_main.shared.db.db_user_tokens.decrypt_value")
...
class TestUserTokenDB:
    ...
    def test_init_creates_database(self, monkeypatch, db_config):
        ...
        mock_db = MagicMock()
        monkeypatch.setattr("src.app_main.shared.db.db_user_tokens.Database", lambda db_data: mock_db)
    ...
    @patch("src.app_main.shared.db.db_user_tokens.encrypt_value")
    ...
    @patch("src.app_main.shared.db.db_user_tokens.encrypt_value")
    @patch("src.app_main.shared.db.db_user_tokens.current_ts")
