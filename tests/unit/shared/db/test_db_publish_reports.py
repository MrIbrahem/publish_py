...
import pytest
from src.new_app.shared.db.db_publish_reports import (
    _VALID_COLUMNS,
...
class TestQueryWithFilters:
    ...
    def mock_db(self):
        ...
        with patch("src.new_app.shared.db.db_publish_reports.Database") as MockDatabase:
...
class TestReportRecord:
    ...
    def test_create_with_required_fields(self):
        ...
        from src.new_app.shared.db.db_publish_reports import ReportRecord
...
class TestValidColumns:
    ...
    def test_contains_expected_columns(self):
        ...
        from src.new_app.shared.db.db_publish_reports import _VALID_COLUMNS
    ...
    def test_all_param_columns_are_valid(self):
        ...
        from src.new_app.shared.db.db_publish_reports import _VALID_COLUMNS, PUBLISH_REPORTS_PARAMS
