"""Tests for clients.revids_service module."""
...
class TestGetRevid:
    ...
    def test_returns_empty_string_when_file_not_found(self):
        ...
        from src.app_main.shared.clients.revids_service import get_revid
...
class TestGetRevidDb:
    ...
    def test_returns_empty_string_on_error(self):
        ...
        with patch("src.app_main.shared.clients.revids_service.requests") as mock_requests:
            mock_requests.get.side_effect = Exception("Network error")

            from src.app_main.shared.clients.revids_service import get_revid_db
