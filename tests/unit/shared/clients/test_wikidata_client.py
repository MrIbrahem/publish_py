...
class TestGetQidForMdtitle:
    ...
    def test_returns_qid_when_found(self):
        ...
        with patch("src.main_app.shared.clients.wikidata_client.get_page_qid") as mock_get_db:
            ...
            from src.main_app.shared.clients.wikidata_client import get_qid_for_mdtitle
...
class TestLinkToWikidata:
    ...
    def test_returns_success_on_successful_link(self):
        ...
        with (
            patch("src.main_app.shared.clients.wikidata_client.get_qid_for_mdtitle") as mock_qid,
            patch("src.main_app.shared.clients.wikidata_client._link_it") as mock_link,
        ):
            mock_qid.return_value = "Q12345"
            mock_link.return_value = {"success": True}

            from src.main_app.shared.clients.wikidata_client import link_to_wikidata
    ...
    def test_returns_error_when_no_credentials(self):
        ...
        with patch("src.main_app.shared.clients.wikidata_client.get_qid_for_mdtitle") as mock_qid:
            mock_qid.return_value = "Q12345"
