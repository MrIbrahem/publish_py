...
class TestPublishDoEdit:
    ...
    def test_returns_edit_result_on_success(self):
        ...
        with patch("src.new_app.shared.clients.mediawiki_api.post_params") as mock_post:
            mock_post.return_value = '{"edit": {"result": "Success", "newrevid": 12345}}'

            from src.new_app.shared.clients.mediawiki_api import publish_do_edit
...
class TestGetTitleInfo:
    ...
    def test_returns_page_info_on_success(self):
        ...
        with patch("src.new_app.shared.clients.mediawiki_api.requests") as mock_requests:
            ...
            from src.new_app.shared.clients.mediawiki_api import get_title_info
