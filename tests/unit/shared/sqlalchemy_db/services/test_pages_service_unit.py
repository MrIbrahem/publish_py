...
import pytest
from src.app_main.shared.domain.services.page_service import (
    add_or_update_page,
    add_page,
    delete_page,
...
class TestGetPagesDb:
    ...
    def test_returns_cached_instance_on_subsequent_calls(self, monkeypatch):
        ...
        mock_db = MagicMock()
        monkeypatch.setattr("src.app_main.shared.domain.services.page_service._PAGE_STORE", mock_db)
        monkeypatch.setattr("src.app_main.shared.domain.services.page_service.has_db_config", lambda: True)
    ...
    def test_raises_when_no_db_config(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.shared.domain.services.page_service._PAGE_STORE", None)
        monkeypatch.setattr("src.app_main.shared.domain.services.page_service.has_db_config", lambda: False)
    ...
    def test_creates_new_instance_when_cached_is_none(self, monkeypatch):
        ...
        with patch("src.app_main.shared.domain.services.page_service.PagesDB") as MockPagesDB:
...
class TestListPages:
    ...
    def test_returns_list_of_pages(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.shared.domain.services.page_service.get_pages_db", lambda: mock_store)
