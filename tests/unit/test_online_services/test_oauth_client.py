"""Tests for online_services.oauth_client module."""
...
class TestGetOauthClient:
    ...
    def test_creates_oauth1_object(self):
        ...
        with patch("src.app_main.online_services.oauth_client.settings") as mock_settings:
            mock_settings.oauth.consumer_key = "test_consumer_key"
            mock_settings.oauth.consumer_secret = "test_consumer_secret"

            from src.app_main.online_services.oauth_client import get_oauth_client
...
class TestGetCsrfToken:
    ...
    def test_returns_token_response(self):
        ...
        with (
            patch("src.app_main.online_services.oauth_client.requests") as mock_requests,
            patch("src.app_main.online_services.oauth_client.settings") as mock_settings,
        ):
            ...
            from src.app_main.online_services.oauth_client import get_csrf_token
...
class TestPostParams:
    ...
    def test_includes_csrf_token_in_request(self):
        ...
        with (
            patch("src.app_main.online_services.oauth_client.get_csrf_token") as mock_get_token,
            patch("src.app_main.online_services.oauth_client.requests") as mock_requests,
            patch("src.app_main.online_services.oauth_client.settings") as mock_settings,
        ):
            mock_settings.oauth.consumer_key = "test_key"
            ...
            from src.app_main.online_services.oauth_client import post_params
...
class TestGetCxtoken:
    ...
    def test_returns_cxtoken_response(self):
        ...
        with patch("src.app_main.online_services.oauth_client.post_params") as mock_post:
            mock_post.return_value = '{"cxtoken": "some_cx_token"}'

            from src.app_main.online_services.oauth_client import get_cxtoken
