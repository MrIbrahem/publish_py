...
class TestGetProjectsDb:
    ...
    def test_returns_cached_instance(self, monkeypatch):
        ...
        mock_db = MagicMock()
        monkeypatch.setattr("src.app_main.public.domain.services.project_service._PROJECTS_STORE", mock_db)
        monkeypatch.setattr("src.app_main.public.domain.services.project_service.has_db_config", lambda: True)
    ...
    def test_raises_when_no_db_config(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.public.domain.services.project_service._PROJECTS_STORE", None)
        monkeypatch.setattr("src.app_main.public.domain.services.project_service.has_db_config", lambda: False)
    ...
    def test_creates_new_instance_when_cached_is_none(self, monkeypatch):
        ...
        with patch("src.app_main.public.domain.services.project_service.ProjectsDB") as MockDB:
...
class TestListProjects:
    ...
    def test_returns_list_from_store(self, monkeypatch):
        ...
        monkeypatch.setattr("src.app_main.public.domain.services.project_service.get_projects_db", lambda: mock_store)
