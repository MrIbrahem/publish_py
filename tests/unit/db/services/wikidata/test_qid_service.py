...
class TestAddQid:
    """Tests for add_or_update_qid function."""

    def test_adds_qid_and_returns_record(self, monkeypatch):
        """Test that add_or_update_qid adds a QID and returns the record."""
        record = add_or_update_qid("Jupiter", "Q121")
        assert record.title == "Jupiter"
        assert record.qid == "Q121"

    def test_updates_existing_qid(self, monkeypatch):
        add_or_update_qid("Venus", "Q1")
        updated = add_or_update_qid("Venus", "Q2")
...
class TestUpdateQid:
    ...
    def test_updates_qid_and_returns_record(self, monkeypatch):
        ...
        q = add_or_update_qid("Saturn", "Q193")
...
class TestDeleteQid:
    ...
    def test_deletes_qid(self, monkeypatch):
        ...
        q = add_or_update_qid("Uranus", "Q324")
        delete_qid(q.id)
...
class TestListQids:
    ...
    def test_returns_list_of_records(self, monkeypatch):
        ...
        add_or_update_qid("Neptune", "Q332")
        add_or_update_qid("Pluto", "Q339")
        result = list_records()
        assert len(result) >= 2
...
class TestGetTitleToQid:
    ...
    def test_returns_title_to_qid_mapping(self, monkeypatch):
        ...
        add_or_update_qid("Sun", "Q525")
        add_or_update_qid("Moon", "Q405")
        mapping = get_title_to_qid()
...
class TestListQidsByDis:
    ...
    def test_dis_duplicate_returns_rows_sharing_qid(self, monkeypatch):
        ...
        add_or_update_qid("First_title", "Q42")
        add_or_update_qid("Second_title", "Q42")
        add_or_update_qid("Solo_title", "Q43")
