...
from src.app.helpers.files import _get_rand_id, get_reports_dir, to_do
...
class TestGetReportsDir:
    ...
    def test_follows_expected_structure(self):
...
class TestToDo:
    ...
    def test_writes_to_log_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            with patch("src.app.helpers.files.settings") as mock_settings:
                mock_settings.paths.log_dir = tmpdir
