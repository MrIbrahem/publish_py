...
class BasePublishTest:
    ...
    @pytest.fixture(autouse=True)
    def mock_token(self):
        with patch("src.main_app.public.routes.publish.routes.UserTokenService.get_user_token_by_username") as mock_get_token:
            token = MagicMock()
    ...
    def common_patches(self):
        ...
        with (
            ...
            patch("src.main_app.public.routes.publish.to_db.UserPagesService.insert_user_page_target") as mock_insert_user_page,
        ):
