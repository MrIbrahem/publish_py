...
class TestApiRoutes:
    ...
    def test_api_preflight(self, mock_client: FlaskClient):
    ...
    def test_publish_reports_success(self, mock_client: FlaskClient):
    ...
    def test_publish_reports_with_filters(self, mock_client: FlaskClient):
        """Test that publish_reports accepts various filter parameters."""
        response = mock_client.get("/api/publish_reports?year=2023&month=1&lang=en&limit=10")
    ...
    def test_publish_reports_select_fields(self, mock_client: FlaskClient):
    ...
    def test_publish_reports_stats_success(self, mock_client: FlaskClient):
    ...
    def test_in_process_success(self, mock_client: FlaskClient):
    ...
    def test_in_process_with_lang_filter(self, mock_client: FlaskClient):
    ...
    def test_in_process_total_success(self, mock_client: FlaskClient):
    ...
    def test_pages_users_success(self, mock_client: FlaskClient):
    ...
    def test_categories_success(self, mock_client: FlaskClient):
    ...
    def test_users_by_translations_count_success(self, mock_client: FlaskClient):
    ...
    def test_langs_success(self, mock_client: FlaskClient):
    ...
    def test_top_langs_route(self, mock_client: FlaskClient):
    ...
    def test_top_users_route(self, mock_client: FlaskClient):
