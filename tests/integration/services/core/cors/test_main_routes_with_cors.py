...
class TestCorsIntegration1:
    ...
    def test_cors_headers_on_allowed_origin(self, mock_client, monkeypatch):
        ...
        monkeypatch.setattr(
            "src.main_app.services.core.cors.is_allowed_checker.is_allowed", lambda req: "https://example.com"
        )
        monkeypatch.setattr("src.main_app.services.core.cors.is_allowed", lambda req: "https://example.com")
