...
class TestValidateAccessOnPublish:
    ...
    def test_post_disallowed_origin_returns_403(self, client):
        ...
        with (
            patch("src.app_main.cors.is_allowed", return_value=None),
            patch("src.app_main.cors.check_publish_secret_code", return_value=None),
        ):
    ...
    def test_post_with_valid_secret_key_bypasses_cors(self, client):
        ...
        with (
            patch("src.app_main.cors.is_allowed", return_value=None),
            patch("src.app_main.cors.check_publish_secret_code", return_value="evil.com"),
            patch(
                "src.app_main.app_routes.publish.routes.get_user_token_by_username",
                return_value=None,
            ),
