...
class TestDatabaseIntegration:
    ...
    def test_database_initialization(self):
        ...
        from src.app_main.db.db_class import Database
        ...
        with patch("src.app_main.db.db_class.pymysql.connect") as mock_connect:
            mock_conn = MagicMock()
...
class TestPagesDBIntegration:
    ...
    def test_pages_db_creates_tables_on_init(self):
        ...
        from src.app_main.config import DbConfig
        from src.app_main.db.db_Pages import PagesDB
        ...
        with patch("src.app_main.db.db_Pages.Database") as MockDB:
...
class TestUserTokenDBIntegration:
    ...
    def test_user_token_db_creates_table_on_init(self):
        ...
        from src.app_main.config import DbConfig
        from src.app_main.db.db_user_tokens import UserTokenDB
        ...
        with patch("src.app_main.db.db_user_tokens.Database") as MockDB:
            mock_db_instance = MagicMock()
            MockDB.return_value = mock_db_instance
...
class TestQidsDBIntegration:
    ...
    def test_qids_db_creates_table_on_init(self):
        ...
        from src.app_main.config import DbConfig
        from src.app_main.db.db_qids import QidsDB
        ...
        with patch("src.app_main.db.db_qids.Database") as MockDB:
            mock_db_instance = MagicMock()
            MockDB.return_value = mock_db_instance
...
class TestReportsDBIntegration:
    ...
    def test_reports_db_creates_table_on_init(self):
        ...
        with patch("src.app_main.db.db_publish_reports.Database") as MockDB:
            mock_db_instance = MagicMock()
            MockDB.return_value = mock_db_instance
...
class TestCategoriesDBIntegration:
    ...
    def test_categories_db_creates_table_on_init(self):
        ...
        from src.app_main.config import DbConfig
        from src.app_main.db.db_categories import CategoriesDB
        ...
        with patch("src.app_main.db.db_categories.Database") as MockDB:
            mock_db_instance = MagicMock()
            MockDB.return_value = mock_db_instance
