...
class TestSettingsDashboard:
    ...
    def test_settings_dashboard_requires_admin(self, client: FlaskClient):
...
class TestCreateSetting:
    ...
    def test_create_setting_requires_admin(self, client: FlaskClient):
    ...
    def test_create_setting_invalid_key_format(self, auth_client: FlaskClient):
...
class TestUpdateSetting:
    ...
    def test_update_setting_requires_admin(self, client: FlaskClient):
