...
-   _Example_: "This project needs TypeScript for type safety" → Hand off
...
-   _Example_: "Build a React dashboard" → Hand off
...
-   _Example_: "Create a landing page layout" → Hand off
...
-   _Example_: "Set up complete testing infrastructure" → Collaborate or hand off
